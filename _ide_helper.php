 ...
 * Generated for Laravel 5.3.10 on 2016-10-06.
 *
...
namespace {
    ...
    class Laratrust extends \Laratrust\LaratrustFacade{
        ...
        public static function hasRole($role, $requireAll = false){
            return \Laratrust\Laratrust::hasRole($role, $requireAll);
        }
        ...
        public static function can($permission, $requireAll = false){
            return \Laratrust\Laratrust::can($permission, $requireAll);
        }
        ...
        public static function ability($roles, $permissions, $options = array()){
            return \Laratrust\Laratrust::ability($roles, $permissions, $options);
        }
        
        /**
         * Get the currently authenticated user or null.
         *
         * @return \Laratrust\Illuminate\Auth\UserInterface|null 
         * @static 
         */
        public static function user(){
        ...
        public static function routeNeedsRole($route, $roles, $result = null, $requireAll = true){
            return \Laratrust\Laratrust::routeNeedsRole($route, $roles, $result, $requireAll);
        }
        ...
        public static function routeNeedsPermission($route, $permissions, $result = null, $requireAll = true){
            return \Laratrust\Laratrust::routeNeedsPermission($route, $permissions, $result, $requireAll);
        }
